...
class SkillContractTest(unittest.TestCase):
    ...
    def test_review_is_bounded(self):
        text = self.read_skill("processon-review")
    ...
    def test_setup_skill_routes_all_credential_states(self):
        setup = self.read_skill("processon-setup")
        router = self.read_skill("processon-use")
    ...
    def test_diagram_skill_covers_professional_families(self):
        text = self.read_skill("processon-diagram")
        for value in (
            "flowchart",
            "swimlane",
            "sequence",
    ...
    def test_mindmap_skill_defines_seven_structures(self):
        text = self.read_skill("processon-mindmap")
        for value in (
            "mind_free",
            "mind_right",
            "mind_org",
    ...
    def test_infographic_skill_maps_relationships_to_layout(self):
        text = self.read_skill("processon-infographic")
    ...
    def test_architecture_defaults_to_blocks_not_class_tables(self):
        text = self.read_skill("processon-diagram").lower()
