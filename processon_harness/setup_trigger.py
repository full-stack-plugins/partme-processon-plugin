"""Open the local ProcessOn credential UI once when authentication is required."""
...
def launch_setup_ui_once(
    *,
    ...
    """Launch at most one setup window per cooldown without storing a Token."""

    script = Path(plugin_root).resolve() / "scripts" / "processon_setup.py"
